...
eq : Event → Event → Bool
eq (KeyEvent _ key1 pressed1) (KeyEvent _ key2 pressed2) =
  (key1 String.== key2) && (pressed1 Bool.== pressed2)
eq (MouseClick _ click1 x1 y1) (MouseClick _ click2 x2 y2) =
  (click1 Click.== click2) && (x1 F64.== x2) && (y1 F64.== y2)
eq (KeyMouse _ key1 pressed1 x1 y1) (KeyMouse _ key2 pressed2 x2 y2) =
  (key1 String.== key2) && (pressed1 Bool.== pressed2) && (x1 F64.== x2) && (y1 F64.== y2)
eq (MouseMove _ x1 y1) (MouseMove _ x2 y2) =
  (x1 F64.== x2) && (y1 F64.== y2)
